                    ...
                    ->children()
                        ->arrayNode('contact')
                            ...
                            ->children()
                                ...
                                ->scalarNode('manager')->cannotBeEmpty()->defaultValue('Rz\\ContactBundle\\Entity\\ContactManager')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                    ...
                    ->children()
                        ->arrayNode('form')
                            ...
                            ->children()
                                ...
                                ->scalarNode('type')->defaultValue('rz_contact_contact_form')->end()
                                ...
                                ->scalarNode('view')->defaultValue('RzContactBundle:Contact:form.html.twig')->cannotBeEmpty()->end()
                        ...
                        ->arrayNode('block')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('class')->defaultValue('Rz\\ContactBundle\\Block\\ContactUsFormBlockService')->end()
                                ->scalarNode('default_template')->defaultValue('RzContactBundle:Block:block_contact_us.html.twig')->end()
                                ->arrayNode('templates')
                                    ->canBeUnset()
